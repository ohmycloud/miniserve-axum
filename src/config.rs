...
pub struct MiniserveConfig {
    ...
    /// If false, miniserve will serve the current woking directory
    ...
    /// Well-known favicon route (prefixed of route_prefix is provided)
...
impl MiniserveConfig {
    ...
    pub fn try_from_args(args: CliArgs) -> Result<Self> {
        ...
        let prefix_url = if args.random_route {
            "".into()
        } else {
            route_prefix.clone()
        };
        let (healthcheck_route, api_route, favicon_route, css_route) = (
            format!("{}/{}", prefix_url, "__miniserve_internal/healthcheck"),
            format!("{}/{}", prefix_url, "__miniserve_internal/api"),
            format!("{}/{}", prefix_url, "__miniserve_internal/favicon.svg"),
            format!("{}/{}", prefix_url, "__miniserve_internal/style.css"),
        );
